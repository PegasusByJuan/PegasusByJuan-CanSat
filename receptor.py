...
# "20,868,Hello World"
    ...
    def receive(self):
        if self.ser.inWaiting() > 0:
            ...
            # TODO: Aqui falta  guardar los datos en el archivo local que le el excel
...
try:
    print("Iniciando estación de tierra")
    ...
    while True:
        ...
        #    send_deal()
        node.receive()
	# Recibimos por menos tiempo para que no haya errores en la recepcion
        time.sleep(0.5)
    # node.free_serial()
except:
    node.free_serial()
